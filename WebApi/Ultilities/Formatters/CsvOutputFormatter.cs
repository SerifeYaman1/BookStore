...
namespace WebApi.Ultilities.Formatters
{
    public class CsvOutputFormatter:TextOutputFormatter
    {
        ...
        //İlgili type o formatta çıktı vermeye uygun olup olmadığı kontrol edilir.
        protected override bool CanWriteType(Type? type)
        {
            if(typeof(BookDto).IsAssignableFrom(type) || 
                typeof(IEnumerable<BookDto>).IsAssignableFrom(type)) //Liste version 
            {
